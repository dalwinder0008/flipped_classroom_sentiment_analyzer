...
export default function Dashboard() {
  ...
  return (
    ...
    >
      ...
      {/* Filters Section */}
      <motion.div variants={itemVariants}>
        <GlowCard customSize className="p-4 sm:p-6 space-y-4 h-auto" glowColor="blue">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Sentiment Donut */}
        <motion.div variants={itemVariants}>
          <GlowCard customSize className="h-full" glowColor="green">
        ...
        {/* Sentiment Trend */}
        <motion.div variants={itemVariants}>
          <GlowCard customSize className="h-full" glowColor="blue">
        ...
        {/* Emotion Radar */}
        <motion.div variants={itemVariants}>
          <GlowCard customSize className="h-full" glowColor="purple">
        ...
        {/* Recent Feed */}
        <motion.div variants={itemVariants}>
          <GlowCard customSize className="h-full" glowColor="orange">
        ...
        <motion.div variants={itemVariants} className="lg:col-span-2">
          <GlowCard customSize className="h-auto" glowColor="blue">
